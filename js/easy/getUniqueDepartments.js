...
// {
//     let ArrayUniqueDepartment = [];
//     for (let i = 0; i < employees.length; i++)
//     {
//         if (ArrayUniqueDepartment.includes(employees[i].department))
//         {
//             continue;
//         }
//         else
//         {
//             ArrayUniqueDepartment.push(employees[i].department);
//         }
//     }
//     return ArrayUniqueDepartment;
// }
...
function abdelouafi(arr)
{
    let nb = [];

    for (let i = 0; i < arr.length; i++)
    {
        if (nb.includes(arr[i]))
        {
            continue;
        }
        else
